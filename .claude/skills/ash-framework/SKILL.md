---
name: ash-framework
description: "Use this skill when working with Ash Framework resources, actions, queries, authorization, calculations, aggregates, relationships, data layers, migrations, code interfaces, or any Ash extension (ash_postgres, ash_phoenix, ash_authentication)."
metadata:
...
```sh
mix usage_rules.search_docs "search term" -p ash -p ash_cloak -p ash_phoenix -p ash_postgres
```
